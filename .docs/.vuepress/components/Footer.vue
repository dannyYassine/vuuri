<template>
  <footer class="spacer-top">
    <nav>
      <div class="nav-item">
        <a class="nav-item-link" href="https://github.com/dannyyassine/vuuri#table-of-contents">
          <span class="nav-item-text">Docs</span>
          <span class="nav-item-icon">
              <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" preserveAspectRatio="xMidYMid meet">
      ...
      <div class="nav-item">
        <a class="nav-item-link" href="https://github.com/dannyyassine/vuuri">
          <span class="nav-item-text">Repo</span>
          <span class="nav-item-icon">
              <svg aria-hidden="true" focusable="false" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 496 512" preserveAspectRatio="xMidYMid meet">
